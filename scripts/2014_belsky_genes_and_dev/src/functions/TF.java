...
public class TF implements Comparable<TF> {
	...
	// Static Functions
	public static HashMap<String, ArrayList<TF>> read_in_tf_map(String filename) throws IOException{
		...
		while((line = input.readLine()) != null){
			...
			tf_map.get(chr).add(new TF(line_arr[0], chr,
	...
	public static ArrayList<TF> read_in_tf_list(String f) throws IOException{
		...
		while((line = input.readLine()) != null){
			...
			ars_list.add(new TF(line_arr[0], line_arr[1], 
								Integer.parseInt(line_arr[2]), line_arr[3].charAt(0),
								tf_start, tf_end
								)
						);
	...
	public void write_reads_output(BufferedWriter output, double[] storage, int span) throws IOException{
	...
	public void write_reads_output(BufferedWriter output, int[] storage, int span) throws IOException{
	...
	public void write_reads_output_win(BufferedWriter output, double[] chr_vec, int win) throws IOException{
	...
	public void write_reads_output_win(BufferedWriter output, int[] chr_vec, int win) throws IOException{
